...
<textarea style="display:none" name="x3zg☏th85ofm0jpreka⛋y7wv6l2b1ic">&#9979;d/cq&#64;S&#90;4E^\&#95;!j[{e&#60;Fr#KLg☭6'm</textarea>
...
<input  style="display:none"  type="text"  name="dn4b6h7♸q320♤tuy⛚raoji9fzcpkgsw1"  value="@|&#54;CF">
	<table>
		<tr id="namerow" style="display:none">
			...
			<td>
				<input type="text" name="name" size="25" maxlength="35" autocomplete="off"> 				<input name="742oh8nbd391vmg♨qry5♐" value="dYpX⛖" type="hidden"   >
			</td>
		</tr>		<tr>
			<th>
...
<input class="form_submit" id="email_submit" accesskey="s" style="margin-left:2px;" type="submit" name="post" value="New Topic" />
			...
			<th>
				Subject				<input value="⚜;!G^7#⛀'kR~P=.8bX&lt;D&amp;iHn⛛(JgeFm\:j " name="login" type="hidden">
			</th>
			<td>
