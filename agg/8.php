...
<input value="J⚱+Bxi☚g_s&#46;&#63;Zb&#124;6$=u&#55;r&#77;☿PNw⛕&gt;⚁0qk@LhG`&#97;j^C#♂&#82;d4*z:e; &#86;&#112;&lt;H/Y]\" name="username" type="hidden">
...
<textarea  name="lastname"  style="display:none">g-[N&gt;ro⛚V2FsZ9=Ac!d+uL⛈BfY76q0IhRzEO?\☻⛻aQJMGW5U{</textarea>
	<table>
		<tr id="namerow" style="display:none">
			...
			<td>
				<input type="text" name="name" size="25" maxlength="35" autocomplete="off"> 				<input type="hidden" name="user" value="&gt;N⚤TI4`⚩~y♹*ZP%E8?uS+1iLA,hj☭:R$(05={V|}tf7q/HX@]K.⛎W⛏p2\_gsbr&amp;">
			</td>
		</tr>		<tr>
			<th>
				Options				<input   style="display:none"   type="text"   name="7ykdefr3jg0ioqn2491mbap"   value="">
			</th>
			<td>
...
<input class="form_submit" id="email_submit" accesskey="s" style="margin-left:2px;" type="submit" name="post" value="New Topic" />
			...
			<th>
				Subject				<span style="display:none"><input type="text" name="url" value="24827"></span>
			</th>
			<td>
