...
<<<<<<< HEAD
					<script type="text/javascript" src="/main.js"></script>
								<title>/poll/ - polling and honesty</title>
...
<input style="display:none" type="text" value="83885" name="firstname">
=======
...
>>>>>>> 64515fafb2ddbb492b478d7256d28ac7ddac384f
	...
	<table>
		<tr id="namerow" style="display:none">
			<th>
<<<<<<< HEAD
				Name				<input style="display:none" type="text" value="Q#50Z?IvfwFV/4x6.S8⚛R%2P3LlqE&lt;yajXt_|&gt;z☄{⛨K☌*']N$B;☎9@Mo-&amp;u♉:sh" name="pq96kxrw♍n0y">
			</th>
			<td>
				<input type="text" name="name" size="25" maxlength="35" autocomplete="off"> 				<input type="hidden" value="⚩v[S3|'pBab8G⛰r}A.%icq1fk:l ⚧LwM`?TY!uRN@⛏no⛋*s){UW j⛯&gt;He♙h" name="message">
			</td>
		</tr>		<tr>
			<th>
				Options				<textarea style="display:none" name="username">Q3V1 )☼dMU(&lt;g$T⛢w;klN=5/FHS%pX_7zn]0sbA&gt;G\IYLj♂{2Zu,}⛊⛦K-r x:ta~E.moc6y@h8e♸[C&amp;⛎JB#qO|i^'+`49v☢</textarea>
			</th>
			<td>
								<input type="text" name="email" size="25" maxlength="40" autocomplete="off" id='option_input'>
<input class="form_submit" id="email_submit" accesskey="s" style="margin-left:2px;" type="submit" name="post" value="New Topic" />
								<input style="display:none" type="text" name="search" value="E!Yxz)H \B=5 ]`&gt;☒k{?⚥C⛇QT-q*Ujd⛟PF1iA♴I⚝68h~sfb.OcmM%Kgr@/nNtGJ$X♩_⛌':">
			
			
				<input type="hidden" value="☠♯QNt%⛬jv&lt;)5asJ⚋hu⚐=⚣}k(R-i,W/GHx" name="text">
			</td>
		</tr>		<tr id="subjectrow" style="display:none">
			<th>
				Subject				<input name="q" value="D$_TQ49vnS|(YwK*" type="hidden">
			</th>
			<td>
...
<input class="form_submit" id="subject_submit"  accesskey="s" style="margin-left:2px;" type="submit" name="post" value="New Topic" />
				...
				<tr>
			<th>
				Comment				<input type="hidden" value="!k⚠Oe:BR⚩1w]^qaFTlpU&amp;myGivH+2r*n⚧60Kgx'SP&gt;j☊[♳ 3AENCs;{#\Wc8 ⛵⚲$Z_J}☕oV7" name="3xksl2jcz8q7wr♒opeht⛦bg⛽51dumi">
			</th>
			<td>
				<textarea name="body" id="body" rows="3" cols="40"></textarea>
				<div   style="display:none"><input   type="text"   name="e⛇2⛥81☗azhd7fkpvnctj5bu6i"   value="`R$'☔♦sNt&gt;1l %)F⚷?O-j^95yza,wb6h♹u0q!Tp7Kgv/c{:X;(3E&amp;DrH@|#_Z"></div>
...
<<<<<<< HEAD
<input type="hidden" name="hash" value="a9c46a012ca3f1de2956bb3ebb43171a6f8ed74c">
</form>
...
<<<<<<< HEAD
	<hr /><div class="blotter">Site will be unstable at 20:05<hr/>Proud part of the /qa/ webring with<a style="" href="http://4taba.net/"> http://4taba.net/</a>,<a href="https://qa.booru.org/">https://qa.booru.org/</a> and our redacted chatrooms</div>	<hr />
=======
