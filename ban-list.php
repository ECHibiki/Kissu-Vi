...
<body class="8chan vichan is-not-moderator active-page" data-stylesheet="Dark-kissu.css">
...
<link rel='stylesheet' href='stylesheets/mod/ban-list.css'>
	...
	<form  class="banform">
			...
			<div class='checkboxes'>
								<label><input type="checkbox" id="only_not_expired"> Show only active bans</label>
			</div>
			<div class='buttons'>
	...
	<script>$(function(){ banlist_init("bans.json", [], true); });</script>
